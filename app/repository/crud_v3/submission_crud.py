...
def create_submission(submission_data: Submission, url_objects: list[Url], feature_objects: list[Feature], result_objects: list[Result], session: Session):
    try:
...
def retrieve_submission_info(submission_id: int, session: Session):
    try:
